...
def unmarshal_object(swagger_spec, object_spec, object_value):
    ...
    if object_value is None and schema.is_prop_nullable(swagger_spec, object_spec):
        return None
...
def unmarshal_model(swagger_spec, model_spec, model_value):
    ...
    if model_value is None and schema.is_prop_nullable(swagger_spec, model_spec):
        return None
